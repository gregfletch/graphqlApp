...
describe('UserGuard', () => {
  ...
  describe('canActivate', () => {
    ...
    it('returns true if the user is not authenticated and their auth token is not expired', () => {
    ...
    it('returns false if the user is authenticated and their auth token is not expired', () => {
      spyOn(authService, 'isAuthenticated').and.returnValue(true);
      spyOn(authService, 'isTokenExpired').and.returnValue(false);
